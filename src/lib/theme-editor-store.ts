...
export const SECTION_DEFAULT_DATA: Record<SectionType, Record<string, unknown>> = {
  ...
  pricing: {
    title: 'Pricing',
    subtitle: '',
    plans: [{ name: 'Basic', price: '$0', period: '/month', features: [], highlighted: false }],
  },
  cta: {
...
const INITIAL_CONFIG: Partial<ThemeEditorConfig> = {
  ...
  footerColumns: [
    ...
    { title: 'Services', links: [{ label: 'What We Do', url: '/services' }] },
    { title: 'Resources', links: [{ label: 'Blog', url: '/blog' }] },
    { title: 'Contact', links: [{ label: 'Get in Touch', url: '/contact' }] },
  ],
