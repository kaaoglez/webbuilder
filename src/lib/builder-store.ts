...
import type { BuilderPage, PageData, PageSection, PageTemplate, PageTheme, PageSEO, SiteNavigation, GlobalSettings, BlogPost } from './builder-types';
...
interface BuilderState {
  ...
  // ── NEW: SEO ──
  seo: PageSEO | null;
  setSeo: (seo: PageSEO | null) => void;

  // ── NEW: Navigation ──
  navigation: SiteNavigation | null;
  setNavigation: (navigation: SiteNavigation | null) => void;
