...
import { SECTION_META, TEMPLATE_META, SECTION_SIZING_CAPABILITIES } from '@/lib/builder-types';
import type {
  SectionType,
  PageSection,
  HeroSection,
...
import { SizingControls } from '@/components/builder/SizingControls';
import {
  Command,
  CommandEmpty,
  CommandGroup,
  ...
  return (
    <div className="space-y-5">
      ...
      <SizingControls
        ...
        onChange={(s) => onUpdate({ sizing: s } as any)}
        capabilities={SECTION_SIZING_CAPABILITIES['hero']}
      />
</div>
  );
}
  ...
  return (
    <div className="space-y-5">
      ...
      <SizingControls
        sizing={section.sizing || {}}
        onChange={(s) => onUpdate({ sizing: s } as any)}
        capabilities={SECTION_SIZING_CAPABILITIES['features']}
      />
</div>
  );
}
  ...
  return (
    <div className="space-y-5">
      ...
      <SizingControls
        sizing={section.sizing || {}}
        onChange={(s) => onUpdate({ sizing: s } as any)}
        capabilities={SECTION_SIZING_CAPABILITIES['about']}
      />
</div>
  );
}
  ...
  return (
    <div className="space-y-5">
      ...
      <SizingControls
        sizing={section.sizing || {}}
        onChange={(s) => onUpdate({ sizing: s } as any)}
        capabilities={SECTION_SIZING_CAPABILITIES['testimonials']}
      />
</div>
  );
}
  ...
  return (
    <div className="space-y-5">
      ...
      <SizingControls
        sizing={section.sizing || {}}
        onChange={(s) => onUpdate({ sizing: s } as any)}
        capabilities={SECTION_SIZING_CAPABILITIES['pricing']}
      />
</div>
  );
}
  ...
  return (
    <div className="space-y-5">
      ...
      <SizingControls
        sizing={section.sizing || {}}
        onChange={(s) => onUpdate({ sizing: s } as any)}
        capabilities={SECTION_SIZING_CAPABILITIES['cta']}
      />
</div>
  );
}
  ...
  return (
    <div className="space-y-5">
      ...
      <SizingControls
        sizing={section.sizing || {}}
        onChange={(s) => onUpdate({ sizing: s } as any)}
        capabilities={SECTION_SIZING_CAPABILITIES['contact']}
      />
</div>
  );
}
  ...
  return (
    <div className="space-y-5">
      ...
      <SizingControls
        sizing={section.sizing || {}}
        onChange={(s) => onUpdate({ sizing: s } as any)}
        capabilities={SECTION_SIZING_CAPABILITIES['gallery']}
      />
</div>
  );
}
  ...
  return (
    <div className="space-y-5">
      ...
      <SizingControls
        sizing={section.sizing || {}}
        onChange={(s) => onUpdate({ sizing: s } as any)}
        capabilities={SECTION_SIZING_CAPABILITIES['faq']}
      />
</div>
  );
}
  ...
  return (
    <div className="space-y-5">
      ...
      <SizingControls
        sizing={section.sizing || {}}
        onChange={(s) => onUpdate({ sizing: s } as any)}
        capabilities={SECTION_SIZING_CAPABILITIES['stats']}
      />
</div>
  );
}
  ...
  return (
    <div className="space-y-5">
      ...
      <SizingControls
        sizing={section.sizing || {}}
        onChange={(s) => onUpdate({ sizing: s } as any)}
        capabilities={SECTION_SIZING_CAPABILITIES['team']}
      />
</div>
  );
}
  ...
  return (
    <div className="space-y-5">
      ...
      <SizingControls
        sizing={section.sizing || {}}
        onChange={(s) => onUpdate({ sizing: s } as any)}
        capabilities={SECTION_SIZING_CAPABILITIES['footer']}
      />
</div>
  );
}
...
// ─── Navbar Editor ──────────────────────────────────────────────
function NavbarEditor({ section, onUpdate }: { section: NavbarSection; onUpdate: (data: Partial<NavbarSection>) => void }) {
  const d = section.data;

  const updateLink = (index: number, field: string, value: string) => {
    const newLinks = [...d.links];
    newLinks[index] = { ...newLinks[index], [field]: value };
    onUpdate({ data: { ...d, links: newLinks } });
  };

  const removeLink = (index: number) => {
    onUpdate({ data: { ...d, links: d.links.filter((_, i) => i !== index) } });
  };

  const addLink = () => {
    onUpdate({ data: { ...d, links: [...d.links, { id: uid(), label: 'Nuevo Enlace', url: '#', children: [] }] } });
  };

  return (
    <div className="space-y-5">
      <SectionHeader title="Editor Navbar" description="Configura la barra de navegación" />
      ...
      <FieldGroup label="Logo">
        <ImageManager value={d.logo} onChange={(url) => onUpdate({ data: { ...d, logo: url } })} />
      </FieldGroup>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <FieldGroup label="Enlace CTA">
          <Input value={d.ctaLink} onChange={(e) => onUpdate({ data: { ...d, ctaLink: e.target.value } })} />
        </FieldGroup>
      </div>

      <FieldGroup label="Estilo">
        <Select value={d.style} onValueChange={(v) => onUpdate({ data: { ...d, style: v as NavbarSection['data']['style'] } })}>
      ...
      <div className="grid grid-cols-2 gap-4">
        <FieldGroup label="Color de Fondo">
          <Input type="color" value={d.backgroundColor} onChange={(e) => onUpdate({ data: { ...d, backgroundColor: e.target.value } })} className="h-9 w-full" />
        </FieldGroup>
        <FieldGroup label="Color de Texto">
          <Input type="color" value={d.textColor} onChange={(e) => onUpdate({ data: { ...d, textColor: e.target.value } })} className="h-9 w-full" />
        </FieldGroup>
      </div>

      <div className="flex items-center justify-between">
        <Label className="text-sm font-medium">Mostrar al hacer Scroll</Label>
        <Switch checked={d.showOnScroll} onCheckedChange={(v) => onUpdate({ data: { ...d, showOnScroll: v } })} />
      </div>
      <div className="flex items-center justify-between">
        <Label className="text-sm font-medium">Menú Móvil</Label>
        <Switch checked={d.mobileMenu} onCheckedChange={(v) => onUpdate({ data: { ...d, mobileMenu: v } })} />
      </div>
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <Label className="text-sm font-medium">Enlaces ({d.links.length})</Label>
          <Button variant="outline" size="sm" onClick={addLink} className="gap-1.5"><Plus className="h-3.5 w-3.5" /> Añadir</Button>
        </div>
        <div className="space-y-2 max-h-[300px] overflow-y-auto pr-1">
          {d.links.map((link, index) => (
            <div key={link.id} className="flex items-center gap-2 group">
              <Input value={link.label} onChange={(e) => updateLink(index, 'label', e.target.value)} placeholder="Texto" className="flex-1 text-sm" />
              <Input value={link.url} onChange={(e) => updateLink(index, 'url', e.target.value)} placeholder="#" className="flex-1 text-sm" />
              <Button variant="ghost" size="icon" className="h-7 w-7 opacity-0 group-hover:opacity-100 text-muted-foreground hover:text-red-600 transition-opacity flex-shrink-0" onClick={() => removeLink(index)}><X className="h-3.5 w-3.5" /></Button>
            </div>
          ))}
        </div>
      </div>
      ...
      <SizingControls
        sizing={section.sizing || {}}
        onChange={(s) => onUpdate({ sizing: s } as any)}
        capabilities={SECTION_SIZING_CAPABILITIES['navbar']}
      />
</div>
  );
}
...
// ─── Blog List Editor ───────────────────────────────────────────
function BlogListEditor({ section, onUpdate }: { section: BlogListSection; onUpdate: (data: Partial<BlogListSection>) => void }) {
  const d = section.data;

  return (
    <div className="space-y-5">
      <SectionHeader title="Editor Lista de Blog" description="Configura la cuadrícula de artículos" />
      ...
      <div className="grid grid-cols-2 gap-4">
        <FieldGroup label="Layout">
          <Select value={d.layout} onValueChange={(v) => onUpdate({ data: { ...d, layout: v as BlogListSection['data']['layout'] } })}>
            <SelectTrigger className="w-full"><SelectValue /></SelectTrigger>
            <SelectContent>
      ...
      <FieldGroup label="Texto &quot;Leer más&quot;">
        <Input value={d.readMoreText} onChange={(e) => onUpdate({ data: { ...d, readMoreText: e.target.value } })} />
      </FieldGroup>

      <div className="grid grid-cols-2 gap-3">
        <div className="flex items-center justify-between">
          <Label className="text-sm">Mostrar Autor</Label>
          <Switch checked={d.showAuthor} onCheckedChange={(v) => onUpdate({ data: { ...d, showAuthor: v } })} />
        </div>
        <div className="flex items-center justify-between">
          <Label className="text-sm">Mostrar Fecha</Label>
          <Switch checked={d.showDate} onCheckedChange={(v) => onUpdate({ data: { ...d, showDate: v } })} />
        </div>
        <div className="flex items-center justify-between">
          <Label className="text-sm">Mostrar Categoría</Label>
          <Switch checked={d.showCategory} onCheckedChange={(v) => onUpdate({ data: { ...d, showCategory: v } })} />
        </div>
        <div className="flex items-center justify-between">
          <Label className="text-sm">Mostrar Extracto</Label>
          <Switch checked={d.showExcerpt} onCheckedChange={(v) => onUpdate({ data: { ...d, showExcerpt: v } })} />
        </div>
      </div>
      ...
      <SizingControls
        sizing={section.sizing || {}}
        onChange={(s) => onUpdate({ sizing: s } as any)}
        capabilities={SECTION_SIZING_CAPABILITIES['blog_list']}
      />
</div>
  );
}
...
// ─── Services Editor ────────────────────────────────────────────
function ServicesEditor({ section, onUpdate }: { section: ServicesSection; onUpdate: (data: Partial<ServicesSection>) => void }) {
  const d = section.data;

  const updateItem = (index: number, field: string, value: string | boolean | string[]) => {
    const newItems = [...d.items];
    newItems[index] = { ...newItems[index], [field]: value };
    onUpdate({ data: { ...d, items: newItems } });
  };
  ...
  const addItem = () => {
    onUpdate({ data: { ...d, items: [...d.items, { id: uid(), icon: 'Star', title: 'Nuevo Servicio', description: '', price: '', features: [], highlighted: false }] } });
  };
  ...
  const addFeature = (itemIndex: number) => {
    const newItems = [...d.items];
    newItems[itemIndex] = { ...newItems[itemIndex], features: [...newItems[itemIndex].features, 'Nueva característica'] };
    onUpdate({ data: { ...d, items: newItems } });
  };

  return (
    <div className="space-y-5">
      <SectionHeader title="Editor de Servicios" description="Catálogo de servicios" />
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <Label className="text-sm font-medium">Servicios ({d.items.length})</Label>
          <Button variant="outline" size="sm" onClick={addItem} className="gap-1.5"><Plus className="h-3.5 w-3.5" /> Añadir</Button>
        </div>
        <div className="space-y-3 max-h-[500px] overflow-y-auto pr-1">
          {d.items.map((item, index) => (
            <Card key={item.id} className="p-3 space-y-2.5 relative group border-l-4" style={{ borderLeftColor: item.highlighted ? '#0F766E' : undefined }}>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <Switch checked={item.highlighted} onCheckedChange={(v) => updateItem(index, 'highlighted', v)} />
                  <span className="text-xs text-muted-foreground">Destacado</span>
                </div>
                <Button variant="ghost" size="icon" className="h-6 w-6 opacity-0 group-hover:opacity-100 text-muted-foreground hover:text-red-600 transition-opacity" onClick={() => removeItem(index)}><X className="h-3.5 w-3.5" /></Button>
              </div>
              <FieldGroup label="Icono">
                <IconPicker value={item.icon} onChange={(icon) => updateItem(index, 'icon', icon)} />
              </FieldGroup>
              <div className="grid grid-cols-2 gap-2">
                <FieldGroup label="Título"><Input value={item.title} onChange={(e) => updateItem(index, 'title', e.target.value)} className="text-sm" /></FieldGroup>
                <FieldGroup label="Precio"><Input value={item.price} onChange={(e) => updateItem(index, 'price', e.target.value)} className="text-sm" /></FieldGroup>
              </div>
              <FieldGroup label="Descripción"><Textarea value={item.description} onChange={(e) => updateItem(index, 'description', e.target.value)} rows={2} className="text-sm resize-none" /></FieldGroup>
              <div className="space-y-1.5">
                <div className="flex items-center justify-between">
                  <Label className="text-xs font-medium">Características ({item.features.length})</Label>
                  <Button variant="ghost" size="sm" onClick={() => addFeature(index)} className="h-6 text-xs gap-1"><Plus className="h-3 w-3" /></Button>
                </div>
                {item.features.map((feat, fi) => (
                  <div key={fi} className="flex items-center gap-1.5 group/feat">
                    <span className="text-emerald-500 text-xs flex-shrink-0">✓</span>
                    <Input value={feat} onChange={(e) => updateFeature(index, fi, e.target.value)} className="text-sm h-7" />
                    <Button variant="ghost" size="icon" className="h-6 w-6 opacity-0 group-hover/feat:opacity-100 text-muted-foreground hover:text-red-600 transition-opacity flex-shrink-0" onClick={() => removeFeature(index, fi)}><X className="h-3 w-3" /></Button>
                  </div>
                ))}
              </div>
            </Card>
      ...
      <SizingControls
        sizing={section.sizing || {}}
        onChange={(s) => onUpdate({ sizing: s } as any)}
        capabilities={SECTION_SIZING_CAPABILITIES['services']}
      />
</div>
  );
}
...
// ─── Video Editor ──────────────────────────────────────────────
function VideoEditor({ section, onUpdate }: { section: VideoSection; onUpdate: (data: Partial<VideoSection>) => void }) {
  const d = section.data;

  return (
    <div className="space-y-5">
      <SectionHeader title="Editor Video" description="Configura el reproductor de video" />

      <FieldGroup label="URL del Video">
        <Input value={d.url} onChange={(e) => onUpdate({ data: { ...d, url: e.target.value } })} placeholder="https://www.youtube.com/embed/..." />
      </FieldGroup>
      <FieldGroup label="Título">
        <Input value={d.title} onChange={(e) => onUpdate({ data: { ...d, title: e.target.value } })} />
      </FieldGroup>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="flex items-center justify-between">
          ...
          <Switch checked={d.autoplay} onCheckedChange={(v) => onUpdate({ data: { ...d, autoplay: v } })} />
        </div>
        <div className="flex items-center justify-between">
          <Label className="text-sm">Silenciado</Label>
          <Switch checked={d.muted} onCheckedChange={(v) => onUpdate({ data: { ...d, muted: v } })} />
        </div>
        <div className="flex items-center justify-between">
          <Label className="text-sm">Controles</Label>
          <Switch checked={d.showControls} onCheckedChange={(v) => onUpdate({ data: { ...d, showControls: v } })} />
        </div>
        <div className="flex items-center justify-between">
          <Label className="text-sm">Overlay</Label>
          <Switch checked={d.overlayEnabled} onCheckedChange={(v) => onUpdate({ data: { ...d, overlayEnabled: v } })} />
        </div>
      </div>

      <FieldGroup label="Aspecto">
        <Select value={d.aspectRatio} onValueChange={(v) => onUpdate({ data: { ...d, aspectRatio: v as VideoSection['data']['aspectRatio'] } })}>
          <SelectTrigger className="w-32"><SelectValue /></SelectTrigger>
      ...
      {d.overlayEnabled && (
        <FieldGroup label="Texto Overlay">
          <Input value={d.overlayText} onChange={(e) => onUpdate({ data: { ...d, overlayText: e.target.value } })} />
        </FieldGroup>
      )}
      ...
      <SizingControls
        sizing={section.sizing || {}}
        onChange={(s) => onUpdate({ sizing: s } as any)}
        capabilities={SECTION_SIZING_CAPABILITIES['video']}
      />
</div>
  );
}
...
// ─── Newsletter Editor ─────────────────────────────────────────
function NewsletterEditor({ section, onUpdate }: { section: NewsletterSection; onUpdate: (data: Partial<NewsletterSection>) => void }) {
  const d = section.data;

  return (
    <div className="space-y-5">
      <SectionHeader title="Editor Newsletter" description="Formulario de suscripción" />
      ...
      <FieldGroup label="Placeholder del Input">
        <Input value={d.inputPlaceholder} onChange={(e) => onUpdate({ data: { ...d, inputPlaceholder: e.target.value } })} />
      </FieldGroup>
      <FieldGroup label="Texto del Botón">
        <Input value={d.buttonText} onChange={(e) => onUpdate({ data: { ...d, buttonText: e.target.value } })} />
      </FieldGroup>
      <FieldGroup label="Mensaje de Éxito">
        <Input value={d.successMessage} onChange={(e) => onUpdate({ data: { ...d, successMessage: e.target.value } })} />
      </FieldGroup>
      ...
      <SizingControls
        sizing={section.sizing || {}}
        onChange={(s) => onUpdate({ sizing: s } as any)}
        capabilities={SECTION_SIZING_CAPABILITIES['newsletter']}
      />
</div>
  );
}
...
// ─── Social Feed Editor ─────────────────────────────────────────
function SocialFeedEditor({ section, onUpdate }: { section: SocialFeedSection; onUpdate: (data: Partial<SocialFeedSection>) => void }) {
  const d = section.data;

  const updatePlatform = (index: number, field: string, value: string) => {
    const newPlatforms = [...d.platforms];
    newPlatforms[index] = { ...newPlatforms[index], [field]: value };
    onUpdate({ data: { ...d, platforms: newPlatforms } });
  };

  const removePlatform = (index: number) => {
    onUpdate({ data: { ...d, platforms: d.platforms.filter((_, i) => i !== index) } });
  };

  const addPlatform = () => {
    onUpdate({ data: { ...d, platforms: [...d.platforms, { id: uid(), platform: 'twitter', url: '', handle: '' }] } });
  };

  return (
    <div className="space-y-5">
      <SectionHeader title="Editor Redes Sociales" description="Feed de redes sociales" />
      ...
      <FieldGroup label="Layout">
        <Select value={d.layout} onValueChange={(v) => onUpdate({ data: { ...d, layout: v as SocialFeedSection['data']['layout'] } })}>
          <SelectTrigger className="w-48"><SelectValue /></SelectTrigger>
          <SelectContent><SelectItem value="grid">Cuadrícula</SelectItem><SelectItem value="carousel">Carrusel</SelectItem><SelectItem value="bar">Barra</SelectItem></SelectContent>
        </Select>
      </FieldGroup>
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <Label className="text-sm font-medium">Plataformas ({d.platforms.length})</Label>
          <Button variant="outline" size="sm" onClick={addPlatform} className="gap-1.5"><Plus className="h-3.5 w-3.5" /> Añadir</Button>
        </div>
        <div className="space-y-2 max-h-[300px] overflow-y-auto pr-1">
          {d.platforms.map((p, index) => (
            <Card key={p.id} className="p-3 space-y-2 relative group">
              <Button variant="ghost" size="icon" className="absolute top-2 right-2 h-6 w-6 opacity-0 group-hover:opacity-100 text-muted-foreground hover:text-red-600 transition-opacity" onClick={() => removePlatform(index)}><X className="h-3.5 w-3.5" /></Button>
              <FieldGroup label="Plataforma">
                <Select value={p.platform} onValueChange={(v) => updatePlatform(index, 'platform', v)}>
                  <SelectTrigger className="w-full"><SelectValue /></SelectTrigger>
                  <SelectContent><SelectItem value="twitter">Twitter</SelectItem><SelectItem value="instagram">Instagram</SelectItem><SelectItem value="linkedin">LinkedIn</SelectItem><SelectItem value="github">GitHub</SelectItem><SelectItem value="youtube">YouTube</SelectItem></SelectContent>
                </Select>
              </FieldGroup>
              <FieldGroup label="URL"><Input value={p.url} onChange={(e) => updatePlatform(index, 'url', e.target.value)} className="text-sm" /></FieldGroup>
              <FieldGroup label="Handle"><Input value={p.handle} onChange={(e) => updatePlatform(index, 'handle', e.target.value)} className="text-sm" /></FieldGroup>
            </Card>
          ))}
        </div>
      </div>
      ...
      <SizingControls
        sizing={section.sizing || {}}
        onChange={(s) => onUpdate({ sizing: s } as any)}
        capabilities={SECTION_SIZING_CAPABILITIES['social_feed']}
      />
</div>
  );
}
...
// ─── Map Embed Editor ──────────────────────────────────────────
function MapEmbedEditor({ section, onUpdate }: { section: MapEmbedSection; onUpdate: (data: Partial<MapEmbedSection>) => void }) {
  const d = section.data;

  return (
    <div className="space-y-5">
      <SectionHeader title="Editor Mapa" description="Mapa embebido" />

      <FieldGroup label="URL del Mapa">
        <Input value={d.url} onChange={(e) => onUpdate({ data: { ...d, url: e.target.value } })} placeholder="https://www.google.com/maps/embed?..." />
      </FieldGroup>
      <FieldGroup label="Título">
        <Input value={d.title} onChange={(e) => onUpdate({ data: { ...d, title: e.target.value } })} />
      </FieldGroup>
      ...
      <div className="grid grid-cols-2 gap-4">
        <FieldGroup label="Altura">
          <Select value={d.height} onValueChange={(v) => onUpdate({ data: { ...d, height: v as MapEmbedSection['data']['height'] } })}>
            <SelectTrigger className="w-full"><SelectValue /></SelectTrigger>
            <SelectContent><SelectItem value="small">Pequeña</SelectItem><SelectItem value="medium">Mediana</SelectItem><SelectItem value="large">Grande</SelectItem><SelectItem value="custom">Personalizada</SelectItem></SelectContent>
          </Select>
        </FieldGroup>
        <FieldGroup label="Estilo">
          <Select value={d.style} onValueChange={(v) => onUpdate({ data: { ...d, style: v as MapEmbedSection['data']['style'] } })}>
            <SelectTrigger className="w-full"><SelectValue /></SelectTrigger>
            <SelectContent><SelectItem value="standard">Estándar</SelectItem><SelectItem value="satellite">Satélite</SelectItem><SelectItem value="dark">Oscuro</SelectItem></SelectContent>
          </Select>
        </FieldGroup>
      </div>

      {d.height === 'custom' && (
        <FieldGroup label="Altura personalizada (px)">
          <Input type="number" value={d.customHeight} onChange={(e) => onUpdate({ data: { ...d, customHeight: e.target.value } })} />
        </FieldGroup>
      )}

      <div className="flex items-center justify-between">
        <Label className="text-sm font-medium">Mostrar Marcador</Label>
        <Switch checked={d.showMarker} onCheckedChange={(v) => onUpdate({ data: { ...d, showMarker: v } })} />
      </div>

      {d.showMarker && (
        <FieldGroup label="Etiqueta del Marcador">
          <Input value={d.markerLabel} onChange={(e) => onUpdate({ data: { ...d, markerLabel: e.target.value } })} />
        </FieldGroup>
      )}
      ...
      <SizingControls
        sizing={section.sizing || {}}
        onChange={(s) => onUpdate({ sizing: s } as any)}
        capabilities={SECTION_SIZING_CAPABILITIES['map_embed']}
      />
</div>
  );
}
...
// ─── Countdown Editor ─────────────────────────────────────────
function CountdownEditor({ section, onUpdate }: { section: CountdownSection; onUpdate: (data: Partial<CountdownSection>) => void }) {
  const d = section.data;

  return (
    <div className="space-y-5">
      <SectionHeader title="Editor Cuenta Regresiva" description="Temporizador con fecha objetivo" />
      ...
      <FieldGroup label="Fecha Objetivo">
        <Input type="datetime-local" value={d.targetDate} onChange={(e) => onUpdate({ data: { ...d, targetDate: e.target.value } })} />
      </FieldGroup>

      <div className="grid grid-cols-2 gap-4">
        <FieldGroup label="Texto CTA"><Input value={d.ctaText} onChange={(e) => onUpdate({ data: { ...d, ctaText: e.target.value } })} /></FieldGroup>
        <FieldGroup label="Enlace CTA"><Input value={d.ctaLink} onChange={(e) => onUpdate({ data: { ...d, ctaLink: e.target.value } })} /></FieldGroup>
      </div>

      <FieldGroup label="Estilo">
        <Select value={d.style} onValueChange={(v) => onUpdate({ data: { ...d, style: v as CountdownSection['data']['style'] } })}>
          <SelectTrigger className="w-40"><SelectValue /></SelectTrigger>
          <SelectContent><SelectItem value="modern">Moderno</SelectItem><SelectItem value="classic">Clásico</SelectItem><SelectItem value="minimal">Minimal</SelectItem></SelectContent>
        </Select>
      </FieldGroup>

      <Separator />

      <Label className="text-sm font-medium">Mostrar Unidades</Label>
      <div className="grid grid-cols-2 gap-3">
        <div className="flex items-center justify-between"><Label className="text-sm">Días</Label><Switch checked={d.showDays} onCheckedChange={(v) => onUpdate({ data: { ...d, showDays: v } })} /></div>
        <div className="flex items-center justify-between"><Label className="text-sm">Horas</Label><Switch checked={d.showHours} onCheckedChange={(v) => onUpdate({ data: { ...d, showHours: v } })} /></div>
        <div className="flex items-center justify-between"><Label className="text-sm">Minutos</Label><Switch checked={d.showMinutes} onCheckedChange={(v) => onUpdate({ data: { ...d, showMinutes: v } })} /></div>
        <div className="flex items-center justify-between"><Label className="text-sm">Segundos</Label><Switch checked={d.showSeconds} onCheckedChange={(v) => onUpdate({ data: { ...d, showSeconds: v } })} /></div>
      </div>
    
      <SizingControls
        sizing={section.sizing || {}}
        onChange={(s) => onUpdate({ sizing: s } as any)}
        capabilities={SECTION_SIZING_CAPABILITIES['countdown']}
      />
</div>
  );
}
...
// ─── Tabs Editor ────────────────────────────────────────────────
function TabsEditor({ section, onUpdate }: { section: TabsSection; onUpdate: (data: Partial<TabsSection>) => void }) {
  const d = section.data;
  ...
  const addItem = () => {
    onUpdate({ data: { ...d, items: [...d.items, { id: uid(), label: 'Nueva Pestaña', icon: 'Star', content: 'Contenido de la pestaña.' }] } });
  };

  return (
    <div className="space-y-5">
      <SectionHeader title="Editor Pestañas" description="Contenido en pestañas" />

      <FieldGroup label="Estilo">
        <Select value={d.style} onValueChange={(v) => onUpdate({ data: { ...d, style: v as TabsSection['data']['style'] } })}>
          <SelectTrigger className="w-40"><SelectValue /></SelectTrigger>
          <SelectContent><SelectItem value="line">Línea</SelectItem><SelectItem value="card">Tarjeta</SelectItem><SelectItem value="pill">Píldora</SelectItem></SelectContent>
        </Select>
      </FieldGroup>
      <FieldGroup label="Pestaña por defecto">
        <Input type="number" min={0} max={d.items.length - 1} value={d.defaultTab} onChange={(e) => onUpdate({ data: { ...d, defaultTab: Number(e.target.value) } })} className="w-20" />
      </FieldGroup>
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <Label className="text-sm font-medium">Pestañas ({d.items.length})</Label>
          <Button variant="outline" size="sm" onClick={addItem} className="gap-1.5"><Plus className="h-3.5 w-3.5" /> Añadir</Button>
        </div>
        <div className="space-y-3 max-h-[420px] overflow-y-auto pr-1">
          {d.items.map((item, index) => (
            <Card key={item.id} className="p-3 space-y-2.5 relative group">
              <Button variant="ghost" size="icon" className="absolute top-2 right-2 h-6 w-6 opacity-0 group-hover:opacity-100 text-muted-foreground hover:text-red-600 transition-opacity" onClick={() => removeItem(index)}><X className="h-3.5 w-3.5" /></Button>
              <div className="grid grid-cols-2 gap-2">
                <FieldGroup label="Etiqueta"><Input value={item.label} onChange={(e) => updateItem(index, 'label', e.target.value)} className="text-sm" /></FieldGroup>
                <FieldGroup label="Icono"><IconPicker value={item.icon} onChange={(icon) => updateItem(index, 'icon', icon)} /></FieldGroup>
              </div>
              <FieldGroup label="Contenido"><Textarea value={item.content} onChange={(e) => updateItem(index, 'content', e.target.value)} rows={3} className="text-sm resize-none" /></FieldGroup>
            </Card>
          ))}
        </div>
      </div>
      ...
      <SizingControls
        sizing={section.sizing || {}}
        onChange={(s) => onUpdate({ sizing: s } as any)}
        capabilities={SECTION_SIZING_CAPABILITIES['tabs']}
      />
</div>
  );
}
...
// ─── Accordion Editor ─────────────────────────────────────────
function AccordionEditor({ section, onUpdate }: { section: AccordionSection; onUpdate: (data: Partial<AccordionSection>) => void }) {
  const d = section.data;
  ...
  const addItem = () => {
    onUpdate({ data: { ...d, items: [...d.items, { id: uid(), question: 'Nueva Pregunta', answer: 'Respuesta...', defaultOpen: false }] } });
  };

  return (
    <div className="space-y-5">
      <SectionHeader title="Editor Acordeón" description="Contenido desplegable" />
      ...
      <div className="flex items-center justify-between">
        <Label className="text-sm font-medium">Permitir múltiples abiertos</Label>
        <Switch checked={d.allowMultiple} onCheckedChange={(v) => onUpdate({ data: { ...d, allowMultiple: v } })} />
      </div>
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <Label className="text-sm font-medium">Items ({d.items.length})</Label>
          <Button variant="outline" size="sm" onClick={addItem} className="gap-1.5"><Plus className="h-3.5 w-3.5" /> Añadir</Button>
        </div>
        <div className="space-y-3 max-h-[420px] overflow-y-auto pr-1">
          {d.items.map((item, index) => (
            <Card key={item.id} className="p-3 space-y-2.5 relative group">
              <Button variant="ghost" size="icon" className="absolute top-2 right-2 h-6 w-6 opacity-0 group-hover:opacity-100 text-muted-foreground hover:text-red-600 transition-opacity" onClick={() => removeItem(index)}><X className="h-3.5 w-3.5" /></Button>
              <FieldGroup label="Pregunta"><Input value={item.question} onChange={(e) => updateItem(index, 'question', e.target.value)} className="text-sm" /></FieldGroup>
              <FieldGroup label="Respuesta"><Textarea value={item.answer} onChange={(e) => updateItem(index, 'answer', e.target.value)} rows={2} className="text-sm resize-none" /></FieldGroup>
              <div className="flex items-center justify-between">
                <Label className="text-xs text-muted-foreground">Abierto por defecto</Label>
                <Switch checked={item.defaultOpen} onCheckedChange={(v) => updateItem(index, 'defaultOpen', v)} />
              </div>
            </Card>
          ))}
        </div>
      ...
      <SizingControls
        sizing={section.sizing || {}}
        onChange={(s) => onUpdate({ sizing: s } as any)}
        capabilities={SECTION_SIZING_CAPABILITIES['accordion']}
      />
</div>
  );
}
...
// ─── Timeline Editor ──────────────────────────────────────────
function TimelineEditor({ section, onUpdate }: { section: TimelineSection; onUpdate: (data: Partial<TimelineSection>) => void }) {
  const d = section.data;
  ...
  const addItem = () => {
    onUpdate({ data: { ...d, items: [...d.items, { id: uid(), date: '', title: 'Nuevo Evento', description: '', icon: 'Star', side: 'left' }] } });
  };

  return (
    <div className="space-y-5">
      <SectionHeader title="Editor Línea de Tiempo" description="Cronología de eventos" />
      ...
      <FieldGroup label="Estilo">
        <Select value={d.style} onValueChange={(v) => onUpdate({ data: { ...d, style: v as TimelineSection['data']['style'] } })}>
          <SelectTrigger className="w-40"><SelectValue /></SelectTrigger>
          <SelectContent><SelectItem value="vertical">Vertical</SelectItem><SelectItem value="horizontal">Horizontal</SelectItem><SelectItem value="alternating">Alternante</SelectItem></SelectContent>
        </Select>
      </FieldGroup>
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <Label className="text-sm font-medium">Eventos ({d.items.length})</Label>
          <Button variant="outline" size="sm" onClick={addItem} className="gap-1.5"><Plus className="h-3.5 w-3.5" /> Añadir</Button>
        </div>
        <div className="space-y-3 max-h-[420px] overflow-y-auto pr-1">
          {d.items.map((item, index) => (
            <Card key={item.id} className="p-3 space-y-2.5 relative group">
              <Button variant="ghost" size="icon" className="absolute top-2 right-2 h-6 w-6 opacity-0 group-hover:opacity-100 text-muted-foreground hover:text-red-600 transition-opacity" onClick={() => removeItem(index)}><X className="h-3.5 w-3.5" /></Button>
              <div className="grid grid-cols-3 gap-2">
                <FieldGroup label="Fecha"><Input value={item.date} onChange={(e) => updateItem(index, 'date', e.target.value)} className="text-sm" /></FieldGroup>
                <FieldGroup label="Lado">
                  <Select value={item.side} onValueChange={(v) => updateItem(index, 'side', v)}>
                    <SelectTrigger className="w-full"><SelectValue /></SelectTrigger>
                    <SelectContent><SelectItem value="left">Izquierda</SelectItem><SelectItem value="right">Derecha</SelectItem><SelectItem value="center">Centro</SelectItem></SelectContent>
                  </Select>
                </FieldGroup>
                <FieldGroup label="Icono"><IconPicker value={item.icon} onChange={(icon) => updateItem(index, 'icon', icon)} /></FieldGroup>
              </div>
      ...
      <SizingControls
        sizing={section.sizing || {}}
        onChange={(s) => onUpdate({ sizing: s } as any)}
        capabilities={SECTION_SIZING_CAPABILITIES['timeline']}
      />
</div>
  );
}
...
function TestimonialSliderEditor({ section, onUpdate }: { section: TestimonialSliderSection; onUpdate: (data: Partial<TestimonialSliderSection>) => void }) {
  const d = section.data;
  ...
  const addTestimonial = () => {
    onUpdate({ data: { ...d, testimonials: [...d.testimonials, { id: uid(), name: '', role: '', avatar: '', quote: '', rating: 5 }] } });
  };

  return (
    <div className="space-y-5">
      <SectionHeader title="Editor Carrusel Testimonios" description="Slider de testimonios" />
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <Label className="text-sm font-medium">Testimonios ({d.testimonials.length})</Label>
          <Button variant="outline" size="sm" onClick={addTestimonial} className="gap-1.5"><Plus className="h-3.5 w-3.5" /> Añadir</Button>
        </div>

        <div className="space-y-3 max-h-[420px] overflow-y-auto pr-1">
          {d.testimonials.map((t, index) => (
            <Card key={t.id} className="p-3 space-y-2.5 relative group">
              <Button variant="ghost" size="icon" className="absolute top-2 right-2 h-6 w-6 opacity-0 group-hover:opacity-100 text-muted-foreground hover:text-red-600 transition-opacity" onClick={() => removeTestimonial(index)}><X className="h-3.5 w-3.5" /></Button>
              <div className="grid grid-cols-2 gap-3">
                <FieldGroup label="Nombre"><Input value={t.name} onChange={(e) => updateTestimonial(index, 'name', e.target.value)} className="text-sm" /></FieldGroup>
                <FieldGroup label="Rol"><Input value={t.role} onChange={(e) => updateTestimonial(index, 'role', e.target.value)} className="text-sm" /></FieldGroup>
              </div>
              <FieldGroup label="Opinión"><Textarea value={t.quote} onChange={(e) => updateTestimonial(index, 'quote', e.target.value)} rows={2} className="text-sm resize-none" /></FieldGroup>
              <FieldGroup label={`Valoración: ${t.rating} estrellas`}>
                <div className="flex items-center gap-1">
                  {[1, 2, 3, 4, 5].map((star) => (
                    <button key={star} type="button" className="p-0.5 hover:scale-110 transition-transform" onClick={() => updateTestimonial(index, 'rating', star)}>
                      <Star className={cn('h-5 w-5 transition-colors', star <= t.rating ? 'text-amber-400 fill-amber-400' : 'text-muted-foreground/30')} />
                    </button>
                  ))}
                </div>
              </FieldGroup>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="flex items-center justify-between"><Label className="text-sm">Autoplay</Label><Switch checked={d.autoplay} onCheckedChange={(v) => onUpdate({ data: { ...d, autoplay: v } })} /></div>
        <div className="flex items-center justify-between"><Label className="text-sm">Puntos</Label><Switch checked={d.showDots} onCheckedChange={(v) => onUpdate({ data: { ...d, showDots: v } })} /></div>
        <div className="flex items-center justify-between"><Label className="text-sm">Flechas</Label><Switch checked={d.showArrows} onCheckedChange={(v) => onUpdate({ data: { ...d, showArrows: v } })} /></div>
      </div>

      {d.autoplay && (
        <FieldGroup label="Velocidad (ms)">
          <Input type="number" min={1000} max={10000} step={500} value={d.autoplaySpeed} onChange={(e) => onUpdate({ data: { ...d, autoplaySpeed: Number(e.target.value) } })} />
        </FieldGroup>
      )}
      ...
      <SizingControls
        sizing={section.sizing || {}}
        onChange={(s) => onUpdate({ sizing: s } as any)}
        capabilities={SECTION_SIZING_CAPABILITIES['testimonial_slider']}
      />
</div>
  );
}
...
function SectionEditorRouter({ section, onUpdate }: { section: PageSection; onUpdate: (data: Partial<PageSection>) => void }) {
  switch (section.type) {
    ...
    case 'navbar':
      return <NavbarEditor section={section as NavbarSection} onUpdate={onUpdate as (data: Partial<NavbarSection>) => void} />;
    case 'blog_list':
      return <BlogListEditor section={section as BlogListSection} onUpdate={onUpdate as (data: Partial<BlogListSection>) => void} />;
    case 'services':
      return <ServicesEditor section={section as ServicesSection} onUpdate={onUpdate as (data: Partial<ServicesSection>) => void} />;
    case 'video':
      return <VideoEditor section={section as VideoSection} onUpdate={onUpdate as (data: Partial<VideoSection>) => void} />;
    case 'newsletter':
      return <NewsletterEditor section={section as NewsletterSection} onUpdate={onUpdate as (data: Partial<NewsletterSection>) => void} />;
    case 'social_feed':
      return <SocialFeedEditor section={section as SocialFeedSection} onUpdate={onUpdate as (data: Partial<SocialFeedSection>) => void} />;
    case 'map_embed':
      return <MapEmbedEditor section={section as MapEmbedSection} onUpdate={onUpdate as (data: Partial<MapEmbedSection>) => void} />;
    case 'countdown':
      return <CountdownEditor section={section as CountdownSection} onUpdate={onUpdate as (data: Partial<CountdownSection>) => void} />;
    case 'tabs':
      return <TabsEditor section={section as TabsSection} onUpdate={onUpdate as (data: Partial<TabsSection>) => void} />;
    case 'accordion':
      return <AccordionEditor section={section as AccordionSection} onUpdate={onUpdate as (data: Partial<AccordionSection>) => void} />;
    case 'timeline':
      return <TimelineEditor section={section as TimelineSection} onUpdate={onUpdate as (data: Partial<TimelineSection>) => void} />;
    case 'testimonial_slider':
      return <TestimonialSliderEditor section={section as TestimonialSliderSection} onUpdate={onUpdate as (data: Partial<TestimonialSliderSection>) => void} />;
    default:
                ...
                {types.map((type) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <Badge variant="secondary" className={cn('text-[10px] px-1.5 py-0 h-4', CATEGORY_COLORS[category])}>
                        {meta.category}
                      </Badge>
                    </CommandItem>
                  );
...
export function PageEditor() {
  ...
  const handleAddSection = useCallback(
    (type: SectionType) => {
      addSection(type);
      toast.success(`Sección "${SECTION_META[type].label}" añadida`);
    },
    [addSection],
  );
  ...
  const handleRemoveSection = useCallback(
    (id: string) => {
      ...
      toast.success(`Sección "${SECTION_META[section.type].label}" eliminada`);
    },
  ...
  const handleDuplicateSection = useCallback(
    (id: string) => {
      ...
      if (!section) return;
      duplicateSection(id);
      toast.success(`Sección "${SECTION_META[section.type].label}" duplicada`);
    },
  ...
  const handleToggleSection = useCallback(
    (id: string) => {
      ...
      if (!section) return;
      toggleSection(id);
      toast.success(`Sección "${SECTION_META[section.type].label}" ${section.enabled ? 'desactivada' : 'activada'}`);
    },
