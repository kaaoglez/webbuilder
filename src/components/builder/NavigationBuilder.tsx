      ...
      <div className="bg-white px-4 py-3">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1 overflow-hidden">
            ...
            <button className="flex items-center gap-1 px-2 py-1.5 text-xs text-gray-400 rounded-md md:hidden">
    ...
    <div style={style}>
      <div
        ...
        className={`group flex items-center gap-2 rounded-lg border bg-white px-3 py-2.5 transition-colors hover:bg-muted ${
          isIndented ? 'border-emerald-200 bg-emerald-50/30' : 'border-gray-200'
        }`}
      >
        {/* Drag handle */}
        <button
        ...
        {editing ? (
          ...
          <div className="flex flex-1 flex-col gap-2">
            <div className="flex items-center gap-2">
              ...
              <Button size="sm" variant="ghost" className="h-8 px-2 text-gray-500 hover:bg-gray-100" onClick={handleCancelEdit}>
                Cancelar
              </Button>
            </div>
            <div className="flex items-center gap-2">
          ...
          <>
            ...
            <div className="flex min-w-0 flex-1 items-center gap-2">
              ...
              {item.href && item.type !== 'dropdown' && (
                <span className="hidden truncate text-xs text-gray-400 sm:inline max-w-[140px]">
                  {item.href}
                </span>
              )}
            </div>
            ...
            <div className="flex flex-shrink-0 items-center gap-0.5 opacity-0 transition-opacity group-hover:opacity-100">
              {item.type === 'dropdown' && (
                <Button
                  size="icon"
                  variant="ghost"
                  className="size-7 text-gray-400 hover:text-emerald-600 hover:bg-emerald-50"
              ...
              <Button
                size="icon"
                variant="ghost"
                className="size-7 text-gray-400 hover:text-gray-700 hover:bg-gray-100"
                onClick={() => setEditing(true)}
      ...
      {item.type === 'dropdown' && addingChild && (
        <div className="ml-10 mt-1 flex items-center gap-2 rounded-lg border border-dashed border-emerald-200 bg-emerald-50/50 px-3 py-2">
          ...
          <Button size="sm" variant="ghost" className="h-7 px-2 text-gray-500 hover:bg-gray-100" onClick={() => setAddingChild(false)}>
        ...
        {editing ? (
          <div className="flex flex-1 flex-col gap-1.5">
            <div className="flex items-center gap-2">
              ...
              <Button size="sm" variant="ghost" className="h-7 px-2 text-gray-500 hover:bg-gray-100" onClick={handleCancelEdit}>
                <Trash2 className="size-3" />
              </Button>
            </div>
            <div className="flex items-center gap-2">
          ...
          <>
            ...
            <div className="flex flex-shrink-0 items-center gap-0.5 opacity-0 transition-opacity group-hover:opacity-100">
              <Button
                size="icon"
                variant="ghost"
                className="size-6 text-gray-400 hover:text-gray-700 hover:bg-gray-100"
                onClick={() => setEditing(true)}
              ...
              <Button
                size="icon"
                variant="ghost"
                className="size-6 text-gray-400 hover:text-red-600 hover:bg-red-50"
                onClick={() => {
  ...
  return (
    <Select value={value} onValueChange={onChange}>
      ...
      <SelectContent>
        ...
        {pages.length === 0 && (
          <SelectItem value="__none" disabled className="text-xs text-gray-400">
            No hay páginas
          </SelectItem>
        )}
      </SelectContent>
        ...
        <CardContent className="pt-4">
          ...
          {!showAddForm && (
            <div className="mt-3">
              <Button
                variant="outline"
                className="w-full gap-2 border-dashed border-gray-300 text-gray-600 hover:border-emerald-300 hover:text-emerald-700 hover:bg-emerald-50"
