...
const STATUS_STYLES: Record<BlogPost['status'], { label: string; className: string }> = {
  DRAFT: { label: 'Borrador', className: 'bg-gray-200 text-gray-700 border-gray-400' },
        ...
        <div className="grid gap-2 sm:grid-cols-2">
          <div className="space-y-1.5">
            ...
            <Input
              ...
              className="h-9"
            />
            <p className="text-xs text-gray-500">Mostrar entre 1 y 50 artículos por página.</p>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-xs text-gray-500">Define cómo se visualizan los artículos.</p>
          </div>
        </div>
      ...
      <CardContent className="space-y-3 p-4">
        ...
        {post.tags.length > 0 && (
          <div className="flex flex-wrap gap-1">
            ...
            {post.tags.length > 3 && (
              <span className="rounded-md bg-gray-200 px-1.5 py-0.5 text-[10px] font-medium text-gray-500">
                +{post.tags.length - 3}
              </span>
            )}
          </div>
        ...
        {/* Actions */}
        <div className="flex items-center gap-1.5 border-t border-gray-400 pt-3">
          <Button
            variant="outline"
            size="sm"
  ...
  if (posts.length === 0) {
    return (
      <Card>
        ...
        <CardContent>
          <div className="flex flex-col items-center justify-center gap-4 rounded-xl border-2 border-dashed border-gray-400 bg-gray-200/50 py-16">
  ...
  return (
    <div className="space-y-2">
      <Label className="text-sm font-medium text-gray-700">
        Etiquetas
        <span className="ml-1 text-xs font-normal text-gray-500">(máx. 10)</span>
      </Label>
      <div className="flex min-h-[40px] flex-wrap items-center gap-1.5 rounded-md border border-gray-400 bg-background px-3 py-2 transition-colors focus-within:border-emerald-400 focus-within:ring-1 focus-within:ring-emerald-400">
        {tags.map((tag) => (
          <span
            key={tag}
        ...
        {tags.length < 10 && (
          <input
            ...
            className="min-w-[100px] flex-1 border-0 bg-transparent text-sm outline-none placeholder:text-gray-500"
          />
        )}
      </div>
      <p className="text-xs text-gray-500">Presiona Enter o coma para añadir etiquetas.</p>
    </div>
  );
}
    ...
    <Card>
      ...
      <CardContent>
        <div className="grid gap-6 lg:grid-cols-[1fr_320px]">
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <span className={`text-xs ${form.excerpt.length > 200 ? 'text-red-500 font-medium' : 'text-gray-500'}`}>
          ...
          <div className="space-y-5 lg:border-l lg:border-gray-400 lg:pl-6">
            {/* Status */}
            <div className="space-y-1.5">
      ...
      {posts.length > 0 && (
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
          {[
            ...
            <div
              key={stat.label}
              className="rounded-xl border border-gray-400 bg-white px-4 py-3 text-center shadow-sm"
            >
