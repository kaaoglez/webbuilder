...
function PageRow({ page }: { page: PageData }) {
  ...
  return (
    <div
      className="flex flex-col gap-3 rounded-lg border border-gray-100 bg-white p-4 transition-colors hover:border-gray-200 sm:flex-row sm:items-center sm:justify-between sm:gap-4"
      role="button"
      tabIndex={0}
