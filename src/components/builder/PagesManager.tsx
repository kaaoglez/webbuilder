...
function StatusBadge({ status }: { status: 'DRAFT' | 'PUBLISHED' | 'ARCHIVED' }) {
  const config = {
    DRAFT: { label: 'Borrador', className: 'bg-gray-200 text-gray-600 border-gray-400' },
    ...
    return (
      <div className="flex items-center gap-1.5">
        ...
        <Button
          variant="ghost"
          size="icon"
          className="h-7 w-7 shrink-0 text-gray-500 hover:bg-gray-200"
          onClick={() => {
            setEditValue(page.name);
            setIsEditing(false);
          }}
...
function PageCard({
  ...
  return (
    <Card
      className="group relative overflow-hidden rounded-xl border border-gray-400 bg-white transition-all duration-200 hover:border-gray-400 hover:shadow-lg"
    >
      {/* Color accent bar */}
      <div
      ...
      <CardContent className="relative p-4 pl-5">
        ...
        {/* Action buttons */}
        <div className="flex items-center gap-1 border-t border-gray-400 pt-3">
          {/* Reorder buttons */}
          <div className="flex items-center gap-0.5">
            <Button
              variant="ghost"
              size="icon"
              className="h-8 w-8 text-gray-500 hover:bg-gray-200 hover:text-gray-600 disabled:opacity-30"
              disabled={isFirst}
              onClick={(e) => {
                e.stopPropagation();
                onMoveUp();
          ...
          <div className="ml-auto flex items-center gap-1">
            ...
            {page.type !== 'home' ? (
              ...
              <Button
                variant="ghost"
                size="icon"
                className="h-8 w-8 cursor-not-allowed text-gray-500"
                disabled
                    ...
                    <button
                      ...
                      className={`group relative flex flex-col items-center gap-2 rounded-xl border-2 p-4 text-center transition-all duration-150 ${
                        isSelected
                          ...
                          : 'border-gray-400 bg-white hover:border-gray-400 hover:bg-gray-200'
    ...
    <div className="mx-auto w-full max-w-6xl space-y-6 px-4 py-6 sm:px-6 lg:px-8">
      ...
      {pages.length > 0 && (
        <div className="flex flex-wrap gap-3">
          <div className="flex items-center gap-1.5 rounded-lg border border-gray-400 bg-white px-3 py-1.5 text-xs text-gray-500">
          ...
          <div className="flex items-center gap-1.5 rounded-lg border border-gray-400 bg-gray-200 px-3 py-1.5 text-xs text-gray-500">
