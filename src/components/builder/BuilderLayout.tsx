...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'seo', label: 'SEO', icon: <Search className="size-5" />, requiresCurrentPage: true },
  { key: 'navigation', label: 'Navegación', icon: <Navigation className="size-5" />, requiresCurrentPage: true },
];
