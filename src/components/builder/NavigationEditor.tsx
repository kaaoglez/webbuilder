...
function SortableNavLink({
  ...
  return (
    <div
      ref={setNodeRef}
      style={style}
      className="group flex items-center gap-2 rounded-lg border border-gray-400 bg-white p-3 transition-all"
    >
      {/* Drag handle */}
      <button
      ...
      <div className="flex items-center gap-2">
        <div className="relative">
          <input
            ...
            className="h-9 w-9 cursor-pointer rounded-md border border-gray-400 p-0.5"
          />
        </div>
        <Input
          value={value}
